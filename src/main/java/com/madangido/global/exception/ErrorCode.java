package com.madangido.global.exception;

import org.springframework.http.HttpStatus;

/**
 * 예외 코드 단일 정의. HTTP status 로 예외 "계열"을 표현한다.
 * (별도 예외 서브클래스 트리 대신 코드+status 로 관리)
 */
public enum ErrorCode {
    ...
    INVALID_SPECIES_ACTIVITY(HttpStatus.BAD_REQUEST, "INVALID_SPECIES_ACTIVITY", "해당 종에서 지원하지 않는 활동 유형입니다."),
    SHED_NOT_SUPPORTED_SPECIES(HttpStatus.BAD_REQUEST, "SHED_NOT_SUPPORTED_SPECIES", "탈피 기록은 크레스티드 게코만 지원합니다."),
