...
public class StringUtil {
  ...
  public static String generateRandomMixAll(int length) {
    ...
    String charNSpecialChar =
        IntStream.concat(
                ...
                IntStream.concat(IntStream.rangeClosed(65, 90), IntStream.rangeClosed(97, 122)))
   ...
   * @return 결과
   */
  public static List<String> splitRespectingQuotes(String value, String delimiter) {
